...
function getStatelessBackendCount() {
    ...
    http.open("GET", "/GettingStartedApplication/StatelessBackendService/?c=" + start);
    http.send();
}
...
function getGuestExeBackendService() {
    ...
    start = new Date().getTime();
    http.open("GET", "/GettingStartedApplication/GuestExeBackendService/?c=" + start);
    http.send();
}
...
function getStatefulBackendServiceDictionary() {
    ...
    start = new Date().getTime();
    http.open("GET", "/GettingStartedApplication/StatefulBackendService/?c=" + start);
    http.send();
}
...
function addStatefulBackendServiceKeyValuePair() {
    ...
    start = new Date().getTime();
    http.open("PUT", "/GettingStartedApplication/StatefulBackendService/?c=" + start);
...
function getActorCount() {
    ...
    start = new Date().getTime();
    http.open("GET", "/GettingStartedApplication/ActorBackendService/?c=" + start);
    http.send();
}
...
function newActor() {
    ...
    start = new Date().getTime();
    http.open("POST", "/GettingStartedApplication/ActorBackendService/?c=" + start);
    http.send();
}
